...
<div class="post-form">
    ...
    <form action="interactions/add_event.php" method="POST" enctype="multipart/form-data">
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            if ($dtp_options_result->num_rows > 0) {
                while ($dtp_option = $dtp_options_result->fetch_assoc()) {
                    ...
                    echo '</div>';
                    echo '<form id="updateForm" method="POST" action="update.php" style="display: none;">';
            ...
            echo '<br>';
            echo '<form action="interactions/add_event_option.php" method="POST" onclick="preventClickPropagation(event)">';
