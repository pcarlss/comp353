...
<body>
    ...
    <div class="top-bar">
        ...
        <?php
        echo '<a href="Events/create_social_event.php"><button><h3>Create Social Event</h3></button></a>';
        echo '<a href="GiftExchange/create_gift_exchange.php"><button><h3>Create Gift Exchange</h3></button></a>';
